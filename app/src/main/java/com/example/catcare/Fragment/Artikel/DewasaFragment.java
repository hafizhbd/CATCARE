 ...
 */
public class DewasaFragment extends Fragment {
    private Button back;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("KUCING DEWASA");
        ...
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("ArtikelC");
        return view;
    }
    @Override
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot postSnapshot : dataSnapshot.getChildren()){
                    ...
                    Upload_Info upload = postSnapshot.getValue(com.example.catcare.Adapter.Upload_Info.class);
                    mUploads.add(upload);
                }

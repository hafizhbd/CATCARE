 ...
 */
public class GambarKH extends Fragment {
    //Deklarasi Variable
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_gambar_kh, container, false);
        getActivity().setTitle("Kucing Hitam");
    ...
    private void firebaseReyclerViewAdapter() {
        ...
        options = new FirebaseRecyclerOptions.Builder<DataModels>()
                ...
                .setQuery(reference.child("KucingHitam"), DataModels.class)

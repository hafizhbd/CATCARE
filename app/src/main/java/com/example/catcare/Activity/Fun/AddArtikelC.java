...
1. Mempercantik UI.
*/
public class AddArtikelC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_artikel_c);
        ...
        mStorageRef_info = FirebaseStorage.getInstance().getReference("ArtikelC");
        mDatabaseref_info = FirebaseDatabase.getInstance().getReference("ArtikelC");
        ...
        mSubmitBtn_info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask_info != null && mUploadTask_info.isInProgress()) {
                    Toast.makeText(AddArtikelC.this, "sedang upload", Toast.LENGTH_SHORT).show();
                } else {
                    uploadfile();
                }
            }
    ...
    private void uploadfile() {
        if (mImageUri != null) {
            ...
            mUploadTask_info = fileReferences.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(AddArtikelC.this, "Upload berhasil", Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(AddArtikelC.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
            ...
            Toast.makeText(AddArtikelC.this, "File tidak di temukan", Toast.LENGTH_SHORT).show();
